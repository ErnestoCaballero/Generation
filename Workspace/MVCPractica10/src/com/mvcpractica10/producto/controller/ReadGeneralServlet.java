...
public class ReadGeneralServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Declaramos e inicializamos los objetos de la conexión.
		...
		try {
			//Se instancía el Driver
			Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
			//Se abre la conexión a la base de datos.
			conn = DriverManager.getConnection(url, usuario, password);
			//Se apunta el objeto statement que nos sirve para ejecutar comandos en la base de datos (Se crea la consola de comandos que apuntan a esa conexión
